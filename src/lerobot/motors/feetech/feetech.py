...
def patch_setPacketTimeout(self, packet_length):  # noqa: N802
    ...
    The 50 ms floor is tuned for direct USB serial. When the port is a socket:// URL
    (ser2net bridge), LAN RTT + jitter routinely exceed that, so the floor is widened
    to 500 ms for bridge connections.
    """
