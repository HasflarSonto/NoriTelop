...
# Absolute path to the xlevr folder. Override with XLEVR_PATH env var
# (e.g. on Windows laptops where the default Linux path won't exist).
XLEVR_PATH = os.environ.get(
    "XLEVR_PATH",
    "/home/cics/Desktop/codes/projects/XLeRobot/XLeVR",
)
